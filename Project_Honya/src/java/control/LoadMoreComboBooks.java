 ...
 * @author asus
 */
@WebServlet(name="LoadMoreComboBooks", urlPatterns={"/loadMoreComboBooks"})
public class LoadMoreComboBooks extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product> list = dao.getComboBooks(amount2);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println("<div class=\" col-12 col-md-6 col-lg-3 productComboBooks\">\n"
                    + "                                <div class=\"card\">\n"
