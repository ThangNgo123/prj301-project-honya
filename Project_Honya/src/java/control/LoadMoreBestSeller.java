 ...
 * @author asus
 */
@WebServlet(name = "LoadMoreBestSeller", urlPatterns = {"/loadMoreBestSeller"})
public class LoadMoreBestSeller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = dao.getBestSeller(amount2);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println("<div class=\" col-12 col-md-6 col-lg-3 productBestSeller\">\n"
                    + "                                <div class=\"card\">\n"
