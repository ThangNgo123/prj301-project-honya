 ...
 * @author asus
 */
@WebServlet(name = "LoadMoreRelatedBooks", urlPatterns = {"/loadMoreRelatedBooks"})
public class LoadMoreRelatedBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int ciddd = Integer.parseInt(cidd);
        int amount2 = Integer.parseInt(amount);
        List<Product> list = dao.getRelatedBooks(ciddd, amount2);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println("<div class=\" col-12 col-md-6 col-lg-3 productRelatedBooks\">\n"
                    + "                                <div class=\"card\">\n"
